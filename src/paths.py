...
GOLD_DISCOUNTS_PATH=f"{CATALOG_NAME}.{GOLD_SCHEMA}.dim_discount"
...
GOLD_SALES_PATH=f"{CATALOG_NAME}.{GOLD_SCHEMA}.fact_sales"
GOLD_RETURNS_PATH=f"{CATALOG_NAME}.{GOLD_SCHEMA}.fact_returns"
